...
/**
 * Strings for component 'tool_uploadcourse', language 'pt_br', branch 'MOODLE_36_STABLE'
 *
...
$string['cannotforcelang'] = 'Sem permissão para forçar a linguagem para este curso';
