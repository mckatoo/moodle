...
$string['addon.mod_choice.resultsnotsynced'] = 'Os resultados não incluem a sua última resposta. Por favor, sincronize para atualizarem eles.';
...
$string['addon.mod_glossary.browsemode'] = 'Navegar nas entradas';
...
$string['addon.mod_glossary.bynewestfirst'] = 'Novos primeiro';
...
$string['addon.mod_lti.errorinvalidlaunchurl'] = 'O URL de lançamento não é válido.';
$string['addon.mod_lti.launchactivity'] = 'Iniciar a atividade';
$string['addon.mod_page.errorwhileloadingthepage'] = 'Erro ao carregar conteúdo da página.';
$string['addon.mod_quiz.cannotsubmitquizdueto'] = 'A tentativa do questionário não pode ser entregue pelas seguintes razões:';
...
$string['addon.mod_quiz.errorbehaviournotsupported'] = 'Esse questionário não pode ser tentado no aplicativo por causa que o seguinte comportamento não é suportado pelo aplicativo:';
...
$string['addon.mod_scorm.warningofflinedatadeleted'] = 'Alguns dados off-line da tentativa {{number}} foram excluídas porque ele não pôde ser criado em uma nova tentativa.';
...
$string['core.cannotconnect'] = 'Não é possível conectar-se: Verifique se digitou a URL corretamente e se seu site usa o Moodle 2.4 ou posterior.';
...
$string['core.commentsnotworking'] = 'Os comentários não podem ser recuperados';
...
$string['core.courses.confirmselfenrol'] = 'Tem certeza de que deseja inscrever-se neste curso?';
...
$string['core.courses.searchcoursesadvice'] = 'Você pode usar o botão de busca para acessar os cursos como convidado ou matricular-se em cursos que permitem que ele.';
$string['core.courses.selfenrolment'] = 'Auto-inscrição';
...
$string['core.fileuploader.readingfile'] = 'Lendo arquivos';
...
$string['core.login.checksiteversion'] = 'Verifique se seu site usa Moodle 2.4 ou superior.';
...
$string['core.login.newsitedescription'] = 'Por favor, digite a URL do seu site Moodle. Note que, pode ser que ele não esteja configurado para trabalhar com este app.';
$string['core.login.notloggedin'] = 'Você precisa estar logado.';
$string['core.login.passwordrequired'] = 'Senha necessária';
$string['core.login.problemconnectingerror'] = 'Estamos com dificuldades em se conectar com';
$string['core.login.problemconnectingerrorcontinue'] = 'Verifique se digitou corretamente o endereço e tente novamente.';
...
$string['core.mainmenu.appsettings'] = 'Configurações do aplicativo';
...
$string['core.question.errorattachmentsnotsupported'] = 'O aplicativo ainda não suporta anexar arquivos à resposta.';
$string['core.question.errorinlinefilesnotsupported'] = 'O aplicativo ainda não suporta a edição direta de arquivos.';
...
$string['core.settings.appready'] = 'Aplicativo pronto';
...
$string['core.settings.devicewebworkers'] = 'Device Web Workers suportados';
...
$string['core.settings.versioncode'] = 'Versão do código';
$string['core.settings.versionname'] = 'Nome da versão';
