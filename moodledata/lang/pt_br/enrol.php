...
/**
 * Strings for component 'enrol', language 'pt_br', branch 'MOODLE_36_STABLE'
 *
 * @package   enrol
...
$string['privacy:metadata:user_enrolments:enrolid'] = 'A instância do plug-in de inscrição';
...
$string['privacy:metadata:user_enrolments:tableexplanation'] = 'O plug-in de inscrição principal armazena usuários inscritos.';
