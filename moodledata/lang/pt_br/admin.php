...
/**
 * Strings for component 'admin', language 'pt_br', branch 'MOODLE_36_STABLE'
 *
 * @package   admin
...
$string['configcourseoverviewfileslimit'] = 'O número máximo de arquivos que podem ser anexados ao sumário do curso página de lista de cursos. A primeira imagem adicionada é usada na visão geral no Painel do Usuário; qualquer arquivo adicional é mostrado somente na página de lista de cursos.';
...
- Moodle em Portguês|https://moodle.org/course/view.php?id=24
-###
...
$string['moodleapp_help'] = '<p>Se você possui uma conta em um site Moodle, você pode acessar todos os seus cursos em seus dispositivos móveis com o nosso aplicativo móvel gratuito.</p><a href="https://moodle.com/mobile-app">Baixe o aplicativo Moodle</a>';
