...
/**
 * Strings for component 'tool_generator', language 'pt_br', branch 'MOODLE_36_STABLE'
 *
...
$string['privacy:metadata'] = 'O plug-in do gerador de dados de desenvolvimento não armazena nenhum dado pessoal.';
