...
/**
 * Strings for component 'tool_xmldb', language 'pt_br', branch 'MOODLE_36_STABLE'
 *
 * @package   tool_xmldb
...
$string['privacy:metadata'] = 'O plug-in do editor XMLDB não armazena nenhum dado pessoal.';
