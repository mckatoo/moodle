...
/**
 * Strings for component 'moodle', language 'pt_br', branch 'MOODLE_36_STABLE'
 *
 * @package   moodle
...
$string['coursealreadyfinished'] = 'Curso já concluído';
...
$string['courseenddateenabled'] = 'Data de fim do curso habilitada por padrão';
$string['courseenddateenabled_desc'] = 'Esta configuração determina se a data final do curso será ativada por padrão para novos cursos e ajustada para a data calculada a partir da duração do curso.';
...
$string['coursenotyetfinished'] = 'O curso ainda não terminou';
$string['coursenotyetstarted'] = 'O curso ainda não começou';
...
$string['coursesearch_help'] = '<p>Você pode pesquisar por várias palavras ao mesmo tempo e pode refinar sua busca da seguinte forma:</p>
<ul>
...
$string['hiddenwithbrackets'] = '(escondido)';
$string['hide'] = 'Ocultar';
...
$string['indicator:accessesafterend'] = 'Curso acessado após a data de fim';
...
$string['indicator:completeduserprofile'] = 'Perfil do usuário está completo';
$string['indicator:completeduserprofile_help'] = 'Este indicador representa que o estudante completou seu perfil.';
...
$string['indicator:potentialcognitive'] = 'Potencial profundidade cognitiva do curso';
...
$string['indicator:readactions'] = 'Leia o montante de ações';
$string['indicator:readactions_help'] = 'Este indicador representa o número de ações de leitura (visualização) realizadas pelo estudante.';
...
$string['sessionforceclean'] = 'Por uma preocupação de segurança, scripts gerados do usuário foram desabilitados nesta sessão';
...
$string['target:coursedropout_help'] = 'Este alvo descreve se o estudante pode ser considerado em risco de desistência.';
$string['targetlabelstudentdropoutno'] = 'Não está em risco';
$string['targetlabelstudentdropoutyes'] = 'Estudante em risco de desistência';
