...
/**
 * Strings for component 'tool_lpmigrate', language 'pt_br', branch 'MOODLE_36_STABLE'
 *
...
$string['privacy:metadata'] = 'O plug-in da ferramenta de migração de Competências não armazena nenhum dado pessoal.';
