...
/**
 * Strings for component 'theme_adaptable', language 'pt_br', branch 'MOODLE_36_STABLE'
 *
...
$string['blockheaderbackgroundcolor'] = 'Bloquear a cor do plano de fundo';
...
$string['blocklayoutbuilderdesc'] = 'Abaixo você pode criar seu próprio layout para regiões de bloco na página inicial.
Para adicionar conteúdo a essas regiões, você precisará <strong>ativar a edição na página inicial do Moodle</strong>.
Então você pode começar a arrastar/soltar blocos nas regiões que você cria!';
...
$string['blocklayoutlayoutrowdesc'] = 'Adicionar / definir layout para a linha de região do bloco na página inicial.';
...
$string['topicsweeksdesc'] = 'Definir estilos para o formato de curso Tópicos / Semanas';
