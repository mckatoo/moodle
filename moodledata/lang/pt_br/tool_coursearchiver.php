...
/**
 * Strings for component 'tool_coursearchiver', language 'pt_br', branch 'MOODLE_36_STABLE'
 *
...
$string['access'] = 'Último acesso antes';
...
$string['errornonnumericaccess'] = 'O acesso deve ser numérico (timestamp do UNIX)';
