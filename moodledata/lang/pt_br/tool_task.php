...
/**
 * Strings for component 'tool_task', language 'pt_br', branch 'MOODLE_36_STABLE'
 *
 * @package   tool_task
...
$string['privacy:metadata'] = 'O plug-in de configuração de tarefas agendadas não armazena dados pessoais.';
