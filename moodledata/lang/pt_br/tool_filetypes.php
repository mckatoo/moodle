...
/**
 * Strings for component 'tool_filetypes', language 'pt_br', branch 'MOODLE_36_STABLE'
 *
...
$string['privacy:metadata'] = 'O plug-in de tipos de arquivo não armazena nenhum dado pessoal.';
