...
/**
 * Strings for component 'tool_installaddon', language 'pt_br', branch 'MOODLE_36_STABLE'
 *
...
$string['privacy:metadata'] = 'O plug-in do plug-in do instalador não armazena nenhum dado pessoal.';
