...
/**
 * Strings for component 'question', language 'pt_br', branch 'MOODLE_36_STABLE'
 *
 * @package   question
...
$string['privacy:metadata:database:question_attempt_step_data'] = 'As etapas de tentativa de pergunta podem ter dados adicionais específicos para essa etapa. Os dados são armazenados na tabela step_data.';
...
$string['privacy:metadata:database:question:timecreated'] = 'A data e a hora em que esta pergunta foi criada.';
