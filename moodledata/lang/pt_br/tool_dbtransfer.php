...
/**
 * Strings for component 'tool_dbtransfer', language 'pt_br', branch 'MOODLE_36_STABLE'
 *
...
$string['privacy:metadata'] = 'O plug-in de transferência de banco de dados não armazena nenhum dado pessoal.';
