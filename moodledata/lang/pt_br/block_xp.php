...
/**
 * Strings for component 'block_xp', language 'pt_br', branch 'MOODLE_36_STABLE'
 *
 * @package   block_xp
...
$string['cannotshowblockconfig'] = 'Normalmente mostro as configurações de aparência aqui, mas não consegui encontrar seu bloco. Para alterar a aparência do bloco, volte [aqui]({$a}) (ou onde você adicionou o bloco), ative o modo de edição e siga a opção "Configurar" na lista suspensa do bloco. Se você não conseguir encontrar o bloco, adicione-o novamente ao seu curso.';
...
$string['displayrelativerank'] = 'Mostrar uma classificação relacionada';
...
$string['give'] = 'dar';
$string['gotofullladder'] = 'Ir para a escada completa';
...
$string['ladderadditionalcols_help'] = 'Essa configuração determina quais colunas adicionais são exibidas na escada. Pressione a tecla CTRL ou CMD enquanto clica para selecionar mais de uma coluna ou para desmarcar uma coluna selecionada.';
$string['ladderempty'] = 'A escada está vazia, certifique-se de voltar mais tarde!';
$string['level'] = 'Nível';
...
$string['privacy:metadata:prefladderpagesize'] = 'O tamanho de página preferido do usuário ao visualizar a escada';
...
$string['privacy:metadata:xp'] = 'Armazena os pontos e o nível de usuários';
...
$string['ranking_help'] = 'A classificação é a posição absoluta do usuário atual na escada. A classificação relativa é a diferença de pontos de experiência entre um usuário e seus vizinhos.';
$string['reallyresetallcoursestodefaults'] = 'Realmente redefinir todas as regras de cursos para as regras padrão? esta ação não é reversível.';
$string['reallyresetcourserulestodefaults'] = 'Realmente redefinir as regras do curso para as regras padrão? esta ação não é reversível.';
...
$string['reallyreverttopluginsdefaults'] = 'Realmente redefinir as regras padrão para os padrões sugeridos pelo plugin? esta ação não é reversível.';
$string['recentrewards'] = 'Recompensas recentes';
$string['requires'] = 'Requerir';
...
$string['shortcode:xpiflevel'] = 'Exibe o conteúdo quando o nível do usuário atual corresponde.';
$string['shortcode:xpiflevel_help'] = 'Consulte os exemplos abaixo para formatar este shortcode. Quando um nível é estritamente especificado, o conteúdo será exibido independentemente das outras regras. As regras _greater_ and _less than_ devem corresponder ao conteúdo a ser exibido. Observe como isso pode, às vezes, resultar no conteúdo para nunca ser exibido! Observe que os professores, ou usuários com recursos de edição, sempre verão tudo.
...
$string['shortcode:xpladder'] = 'Exibe uma parte da escada.';
...
$string['taskcollectionloggerpurge'] = 'Limpar registros de coleta';
