...
$string['unpublishalladvertisedcourses'] = 'Remova todos os cursos que estão publicados no Moodle.net';
$string['unpublishalluploadedcourses'] = 'Todos os cursos que foram carregados para Moodle.net foram excluídos';
