...
/**
 * Strings for component 'amanote', language 'pt_br', branch 'MOODLE_36_STABLE'
 *
 * @package   amanote
...
$string['clicktodownloadnotes'] = 'Download do arquivo de anotações.';
...
$string['importantinformationheading'] = 'Informação importante de instalação';
$string['modifieddate'] = 'Modificado em {$a}';
$string['modulename'] = 'Arquivo anotável';
$string['modulenameplural'] = 'Arquivos anotáveis';
$string['nonotestodownload'] = 'Download do arquivo anotado';
$string['nonotestodownload_help'] = 'Você ainda não tem notas salvas neste documento.';
