...
/**
 * Strings for component 'forum', language 'pt_br', branch 'MOODLE_36_STABLE'
 *
 * @package   forum
...
$string['privacy:metadata:forum_digests:maildigest'] = 'Preferências de digest';
$string['privacy:metadata:forum_digests:userid'] = 'O ID do usuário com a preferência de digest.';
