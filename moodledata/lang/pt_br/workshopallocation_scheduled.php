...
/**
 * Strings for component 'workshopallocation_scheduled', language 'pt_br', branch 'MOODLE_36_STABLE'
 *
...
$string['privacy:metadata'] = 'O plug-in de atribuição agendada não armazena nenhum dado pessoal. Dados pessoais reais sobre quem vai avaliar quem são armazenados pelo próprio módulo do Workshop e eles formam uma base para exportar os detalhes das avaliações.';
