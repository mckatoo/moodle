...
/**
 * Strings for component 'block_filtered_course_list', language 'pt_br', branch 'MOODLE_36_STABLE'
 *
...
$string['configprimarysort'] = 'Os curso serão ordenados dentro de um tópico através deste campo. Escolha "Ordenação" para mostrar os cursos na mesma ordem que vistos na página de gerenciamento de cursos.';
$string['configsecondarysort'] = 'Os curso serão ordenados dentro de um tópico secundariamente através deste campo.';
